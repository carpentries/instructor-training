\documentclass[10pt]{interactiveexamdesign}
\input header

\begin{document}

\begin{matching}[title={Role Matching}]
  Match the following artists with the listed albums.
  \pair{Instructors}{Organize and teach Carpentries workshops}
  \pair{Mentors}{Support instructors as they build their teaching and technical skills}
  \pair{Trainers}{Experienced instructors who inspire and prepare our new instructors}
  \pair{Lesson developers}{Create new lessons}
  \pair{Curriculum advisors}{Provide high-level guidance on the overall structure of a particular curriculum}
  \pair{Lesson maintainers}{Make sure lessons stay accurate, up-to-date, functional, and cohesive}
  \pair{Lesson Infrastructure Team}{Support lesson building and styling}
  \pair{Assessment Network}{Community for those working on assessment to share resources and discuss best practices}
  \pair{Champions}{Work to support existing local communities and attract new communities}
  \pair{Regional Coordinators}{Help to coordinate workshops in their geographical areas}
  \pair{Code of Conduct Committee}{Keep our community friendly, welcoming, and respectful}
  \pair{Core Team}{Organise organisation membership, centrally organise workshops, and maintain instructor records.}
  \pair{Feedback Facilitators}{}
\end{matching}

\begin{shortanswer}[title=What's your role?]
Think about your various experiences, skills, and interests and then consider which of the roles within the Carpentries organizations that are described above fit you best. 
\begin{question}In what ways would you be interested in working with the Carpentries? 
\end{question}
\begin{question}For which roles are you a good fit?\end{question}
