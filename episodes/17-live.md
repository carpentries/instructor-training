...
1. **Engage with everyone in the workshop in multiple ways where possible.** This makes the experience more interactive and less monotonous. Use a microphone and camera showing your face if they are available to make it easier for people with hearing difficulties to understand you. Move around the room or use gestures when not live coding.
