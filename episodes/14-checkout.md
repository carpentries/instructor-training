...
1.  [Make (and send us a link to) a small contribution to a lesson or glossary]({{ page.root }}/14-checkout.md/#1-lesson-contribution).
2.  [Take part in an online community discussion session]({{ page.root }}/14-checkout.md/#2-community-discussion).
3.  [Take part in an online teaching demonstration session]({{ page.root }}/14-checkout.md/#3-teaching-demonstration).
