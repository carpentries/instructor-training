...
![Key Concepts]({{ site.root }}/fig/for-loop-concepts.png)
...
![Relationships]({{ site.root }}/fig/for-loop-arcs.png)
...
![Recommendations]({{ site.root }}/fig/for-loop-rec.png)
...
* [Array Math]({{ site.root }}/fig/array-math.png)
* [Conditionals]({{ site.root }}/fig/conditionals.png)
* [Creating and Destroying Files]({{ site.root }}/fig/create-destroy.png)
* [Sets and Dictionaries in Python]({{ site.root }}/fig/dict-set.png)
* [Input and Output]({{ site.root }}/fig/io.png)
* [Lists and Loops]({{ site.root }}/fig/lists-loops.png)
