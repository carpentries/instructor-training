...
> and *connectivism*
> (which emphasizes the social aspects of learning, particularly those made possible by the Internet, not to be confused with *connectionism*, which is a cognitivist theory of learning by creating connections between concepts).
{: .callout}
