...
|---------- |--------------- |--------------- |------------------------- |
| [Data Organization in Spreadsheets](https://datacarpentry.github.io/spreadsheet-ecology-lesson/index.html) | \* [Dates as Data](https://datacarpentry.github.io/spreadsheet-ecology-lesson/03-dates-as-data.html)<br/> \* [Quality Control](https://datacarpentry.github.io/spreadsheet-ecology-lesson/04-quality-control.html) | \* [Introduction](https://datacarpentry.github.io/spreadsheet-ecology-lesson/00-intro.html)<br/> \* [Formatting Data Tables in Spreadsheets](https://datacarpentry.github.io/spreadsheet-ecology-lesson/01-format-data.html)<br/> \* [Formatting problems](https://datacarpentry.github.io/spreadsheet-ecology-lesson/02-common-mistakes.html)<br/> \* [Exporting data](https://datacarpentry.github.io/spreadsheet-ecology-lesson/05-exporting-data.html) | If using [Dates as Data](https://datacarpentry.github.io/spreadsheet-ecology-lesson/03-dates-as-data.html), begin with the [Date Formats in Spreadsheets](https://datacarpentry.github.io/spreadsheet-ecology-lesson/instructor/03-dates-as-data.html#date-formats-in-spreadsheets) section. |
...
|  Lesson   | Recommended Episodes | [**Not Eligible for Demos**](#ineligible) | Notes
|---------- |--------------- |--------------- |------------------------- |
| [Library Carpentry: Introduction to Tidy Data](https://librarycarpentry.github.io/lc-spreadsheets/) | \* [Dates as Data](https://librarycarpentry.github.io/lc-spreadsheets/03-dates-as-data.html)<br/> \* [Quality Control](https://librarycarpentry.github.io/lc-spreadsheets/04-quality-control.html) | \* [Introduction](https://librarycarpentry.github.io/lc-spreadsheets/00-intro.html)<br/> \* [Formatting Data Tables in Spreadsheets](https://librarycarpentry.github.io/lc-spreadsheets/01-format-data.html)<br/> \* [Formatting problems](https://librarycarpentry.github.io/lc-spreadsheets/02-common-mistakes.html)<br/> \* [Exporting data](https://librarycarpentry.github.io/lc-spreadsheets/05-exporting-data.html) | If using [Dates as Data](https://librarycarpentry.github.io/lc-spreadsheets/03-dates-as-data.html), begin with the [Date Formats in Spreadsheets](https://librarycarpentry.github.io/lc-spreadsheets/03-dates-as-data.html#date-formats-in-spreadsheets) section. |
