...
| [Data Analysis and Visualization in R](https://datacarpentry.org/R-ecology-lesson/index.html) |  \* [Data Visualization with ggplot2](https://datacarpentry.org/R-ecology-lesson/visualizing-ggplot.html) | \* [Introduction to R and RStudio](https://datacarpentry.org/R-ecology-lesson/introduction-r-rstudio.html) | The other episodes depend on actions taken earlier in the lesson - consult [_Teaching Episodes with Dependencies_](#dependencies). |
